...
const SellerDashboard = memo(() => {
  ...
  return (
    <div className="min-h-screen bg-background flex lg:overflow-hidden">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col lg:min-h-0 lg:overflow-y-auto overflow-x-hidden overscroll-contain [-webkit-overflow-scrolling:touch]">
        {/* Top Bar */}
